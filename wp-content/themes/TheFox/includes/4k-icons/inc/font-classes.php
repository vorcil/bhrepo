...
if ( ! function_exists( 'fk_get_all_font_classes' ) ) {

	/**
	 * Returns a list of all CSS classes for all icons
	 *
	 * @return	array CSS class names of all font icons
	 * @see		util-generate-icon-list.py
	 */
	function fk_get_all_font_classes() {
		return array(
	"ba-5",
	"ba-zoom11",
	"ba-add22",
